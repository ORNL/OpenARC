...
public class BanerjeeTest implements DDTest {
    ...
    public BanerjeeTest (SubscriptPair pair) {
        ...
        for (Loop loop: loopnest) {
            ...
            if (N >= 0) {
                bounds.add(BanerjeeTest.LB_any, Long.valueOf(
                        (getNegativePart(A)-getPositivePart(B))*(U-L) +
                        (A-B)*L));
                bounds.add(BanerjeeTest.LB_less, Long.valueOf(
                        getNegativePart(getNegativePart(A)-B)*(U-L-N) +
                        (A-B)*L - B*N));
                bounds.add(BanerjeeTest.LB_equal, Long.valueOf(
                        getNegativePart(A-B)*(U-L) + (A-B)*L));
                bounds.add(BanerjeeTest.LB_greater, Long.valueOf(
                        getNegativePart(A-getPositivePart(B))*(U-L-N) +
                        (A-B)*L + A*N));
                bounds.add(BanerjeeTest.UB_any, Long.valueOf(
                        (getPositivePart(A)-getNegativePart(B))*(U-L) +
                        (A-B)*L));
                bounds.add(BanerjeeTest.UB_less, Long.valueOf(
                        getPositivePart(getPositivePart(A)-B)*(U-L-N) +
                        (A-B)*L - B*N));
                bounds.add(BanerjeeTest.UB_equal, Long.valueOf(
                        getPositivePart(A-B)*(U-L) + (A-B)*L));
                bounds.add(BanerjeeTest.UB_greater, Long.valueOf(
