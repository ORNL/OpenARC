...
public class IPPointsToAnalysis extends IPAnalysis {
    ...
    static {
        ...
        return_to_new.addAll(Arrays.asList(
                ...
                "acc_copyin_const",
                "acc_pcopyin_const",
                "acc_present_or_copyin_const",
                "acc_create_const",
                "acc_pcreate_const",
                "acc_present_or_create_const",
                "acc_copyin_async_wait",
                "acc_pcopyin_async_wait",
                "acc_present_or_copyin_async_wait",
                "acc_create_async_wait",
                "acc_pcreate_async_wait",
                "acc_present_or_create_async_wait"));
            ...
            if (result != null) {
                ...
                if (verbosity >= 3) {
                    ...
                    PrintTools.printlnStatus(3, pass_name, toPrettyDomain(
                            node.getProcedure(), result, Integer.valueOf(0)));
                }
            }
        }
    }
    ...
    */
    ...
    public void analyzeProcedure(IPANode node) {
        ...
        if (verbosity >= 5) {
            PrintTools.printlnStatus(5, pass_name, 
                toPrettyDomain(node.getProcedure(), result, Integer.valueOf(0)));
        }
    }
