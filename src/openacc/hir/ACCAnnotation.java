 ...
 */
	...
	private static final Set<String> no_values =
		new HashSet<String>(Arrays.asList("parallel", "kernels", "serial", 
	...
	private static final List<String> print_order =
			new ArrayList<String>(Arrays.asList( "parallel", "kernels", "serial", "enter", "exit", "mpi",
					"data", "loop", "declare", "update", "atomic", "host_data", "cuda", "internal", "tempinternal",
					"routine", "refname", "num_gang", "num_workers", "vector_length", 
					"gang", "worker", "vector", "seq", "independent", "tile", "reduction", "collapse", 
					"copy", "copyin", "copyout", "create", "present", "pcopy", "pcopyin", "host", "device",
					"pcopyout", "pcreate", "pipe", "pipein", "pipeout", "deviceptr", "device_resident", 
					"private", "firstprivate", "finalize", "sendbuf", "recvbuf", "async", "wait", "if"
					));
	
	// List of OpenACC directives.
	public static final Set<String> OpenACCDirectiveSet = new HashSet(Arrays.asList("parallel", "kernels", "serial", "loop", "data", "host_data",
	...
	public static final Set<String> OpenACCDirectivesWithConditional = new HashSet(Arrays.asList("parallel",
			"kernels", "serial", "data", "enter", "exit", "update"));
	...
	public static final Set<String> OpenACCDirectivesWithWait = new HashSet(Arrays.asList("parallel",
			"kernels", "serial", "enter", "exit", "update"));
	
	// Directives attached to structured blocks
	public static final Set<String> directivesForStructuredBlock = new HashSet(Arrays.asList("parallel", "kernels", "serial", "data", "host_data" )); 
	
	// Directives to specify compute regions
	public static final Set<String> computeRegions = new HashSet(Arrays.asList("parallel", "kernels", "serial"));
	
	// Directives that specify explicit/implicit data regions
	public static final Set<String> dataRegions = new HashSet(Arrays.asList("data", "parallel", "kernels", "serial"));
	
	// Directives that contain data clauses.
	public static final Set<String> dataDirectives = new HashSet(Arrays.asList("data", "declare", "parallel", "kernels", "serial"));
    ...
    * Returns a clone of this annotation object.
	...
	public boolean isValidTo(Annotatable at) {
		...
		if( containsKey("loop") ) {
			...
			//acc wait directive.
			isValid = false;
		} else if( containsKey("parallel") || containsKey("kernels") || containsKey("serial")  ||
