...
public class ACCtoOMP4Translator extends TransformPass {
  ...
  int privateTransformOption = 0;

  public ACCtoOMP4Translator(Program prog, int numAsyncQueues, int enableAdvMapping, int vectorMode, int privTransOption) {
    super(prog);
    program = prog;
    defaultNumAsyncQueues = numAsyncQueues;
    enableAdvancedMapping = enableAdvMapping;
    vectorizationMode = vectorMode;
    privateTransformOption = privTransOption;
