...
*/
		...
		float *u0_r = (float *)malloc(sizeof(float)*NTOTAL);
		float *u0_i = (float *)malloc(sizeof(float)*NTOTAL);
		float *u1_r = (float *)malloc(sizeof(float)*NTOTAL);
		float *u1_i = (float *)malloc(sizeof(float)*NTOTAL);
		float *u2_r = (float *)malloc(sizeof(float)*NTOTAL);
		float *u2_i = (float *)malloc(sizeof(float)*NTOTAL);
...
*/
		//[DEBUG on Aug. 20, 2021] Changed to dynamic allocation.
		float *y0_r = (float *)malloc(sizeof(float)*NTOTAL);
		float *y0_i = (float *)malloc(sizeof(float)*NTOTAL);
		float *y1_r = (float *)malloc(sizeof(float)*NTOTAL);
		float *y1_i = (float *)malloc(sizeof(float)*NTOTAL);
