...
void print_CLI_error(void)
{
	...
	printf("  -d <devices>     Number of devices to run\n");
	...
	printf("  -am <queuemode>  Set the asynchronous mode\n");
	printf("                   1: use a single queue\n");
	printf("                   2: use the same number of queues as that of devices\n");
	printf("                   3: use the same number of queues as the total asynchronous tasks\n");
...
void read_CLI( int argc, char * argv[], int *nthreads, long *n_isotopes, long
    *n_gridpoints, int *lookups, char *HM, unsigned int *nDevices, unsigned int *numItr, unsigned int *asyncMode )
{
	int user_g, i;
	char * arg;	
